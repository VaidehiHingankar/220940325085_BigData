...
public class AnalyzeStock {
	...
	public static class StockAnalyzerMapper extends Mapper<Object, Text, Text, FloatWritable> {
	...
	public static class AggregatorReducer extends Reducer<Text, FloatWritable, Text, FloatWritable> {
